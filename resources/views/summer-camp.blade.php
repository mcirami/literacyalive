...
<section class="location register w-full">
    <div class="page_hero text-center">
        <div class="container mx-auto px-5">
            <h2 class="inline-block relative mb-5">SUMMER 2026 DATES</h2>
            <div class="w-1/3 mx-auto select_wrap relative">
                <h3 class="text-3xl">July 27th-31st</h3>
            </div>
        </div>
    </div>
    ...
    <div class="container mx-auto px-5 relative z-2">
        <div class="container mx-auto px-5">
            ...
            <div class="sub_heading_box">
                <p class="">Register today to attend our Literacy Alive summer Camp from <span class="camp_date font-bold">July 27th-31st</span></p>
            </div>
