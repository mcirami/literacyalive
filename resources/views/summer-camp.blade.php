...
<section class="location register w-full">
    <div class="page_hero text-center">
        <div class="container mx-auto px-5">
            <h2 class="inline-block relative mb-5">SUMMER 2026 DATES TBD</h2>
...
<section class="cost themes w-full pt-20 pb-40 text-center">
    <div class="container mx-auto px-5">
        ...
        <div class="text_wrap w-full mx-auto md:max-w-300">
            <p class="my-5 md:px-20"><!-- $200 per camper for the week.-->Weekly Cost TBD<br>
    ...
    <div class="container mx-auto px-5 relative z-2">
        <div class="container mx-auto px-5">
            ...
            <div class="sub_heading_box">
                <p class=""><!--Register today to attend our Literacy Alive summer Camp on <span class="camp_date font-bold">December 22, 2025-->Registration for 2026 Summer Camps will open in spring of 2026!</span></p>
            </div>
            <p class="mt-6 mb-4 small_container">
                Space will be limited! We keep a small ratio of staff to campers. When we reach 24 enrolled campers we will turn off registration. If there is a lot more interest, we will look into offering more camps!
            </p>
